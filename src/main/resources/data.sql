...
INSERT INTO users (id, first_name, last_name, status, country, city, is_subscribed, description, hard_skill_mark, soft_skill_mark)
SELECT * FROM (
    VALUES
...
) AS new_users (id, first_name, last_name, status, country, city, is_subscribed, description, hard_skill_mark, soft_skill_mark)
WHERE NOT EXISTS (
