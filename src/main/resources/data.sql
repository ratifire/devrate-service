...
INSERT INTO users (id, first_name, last_name, status, country, city, is_subscribed, picture, completed_interviews, conducted_interviews)
SELECT * FROM (
VALUES
    ...
    (8934, 'Andrew', 'Shevchenko', 'Python Developer', 'USA', 'New York', false, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 5, 7),
    (8935, 'Andrii', 'Shevchenko', 'React Developer', 'Ukraine', 'Lviv', true, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 12, 9),
    (8936, 'Марія', 'Іванова', '', 'Ukraine', 'Odessa', true, '', 10, 11),
    (8937, 'Maria', 'Ivanova', 'Full Stack Developer', 'Canada', 'Toronto', false, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 14, 8),
    (8938, 'Mariya', 'Ivanova', 'UI/UX Designer', 'Ukraine', 'Dnipro', true, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 9, 7),
    (8939, 'Олексій', 'Коваленко', 'DevOps Engineer', 'Ukraine', 'Kharkiv', true, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 7, 6),
    (8940, 'Alex', 'Kovalenko', 'Security Engineer', 'USA', 'Los Angeles', false, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 10, 12),
    (8941, 'Oleksii', 'Kovalenko', 'Database Administrator', 'Ukraine', 'Vinnytsia', true, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 6, 8),
    (8942, 'Іван', 'Петренко', 'Cloud Architect', 'Ukraine', 'Zaporizhzhia', true, '', 13, 10),
    (8943, 'Ivan', 'Petrenko', '', 'USA', 'Chicago', true, '', 11, 9),
    (8944, 'Iwan', 'Petrenko', 'System Administrator', 'Ukraine', 'Poltava', false, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 8, 6),
    (8945, 'Софія', 'Сидоренко', 'Machine Learning Engineer', 'Ukraine', 'Kyiv', true, '', 14, 13),
    (8946, 'Sofia', 'Sydorenko', 'Frontend Developer', 'USA', 'San Francisco', true, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 9, 10),
    (8947, 'Sofiia', 'Sydorenko', 'DevOps Consultant', 'Ukraine', 'Chernihiv', false, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 10, 7),
    ...
    (8950, 'Dmitriy', 'Melnyk', 'JavaScript Developer', 'Ukraine', 'Rivne', true, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 10, 10),
    ...
    (8953, 'Anastasiia', 'Honcharenko', 'Mobile Developer', 'Ukraine', 'Ivano-Frankivsk', true, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 9, 8),
    ...
    (8957, 'Віктор', 'Захарчук', 'Data Analyst', 'Ukraine', 'Ternopil', true, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 13, 8),
    (8958, 'Victor', 'Zakharchuk', 'System Analyst', 'USA', 'Seattle', false, '', 9, 10),
    (8959, 'Viktor', 'Zakharchuk', 'Project Manager', 'Ukraine', 'Zhytomyr', true, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 15, 12),
    (8960, 'Катерина', 'Романюк', '', 'Ukraine', 'Kyiv', true, '', 11, 8),
    (8961, 'Katerina', 'Romaniuk', 'Java Developer', 'USA', 'Denver', false, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 10, 7),
    ...
    (8966, 'Михайло', 'Олійник', 'Database Engineer', 'Ukraine', 'Khmelnytskyi', true, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 9, 7),
    ...
    (8969, 'Ірина', 'Григоренко', 'Software Engineer', 'Ukraine', 'Kyiv', true, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 11, 9),
    (8970, 'Iryna', 'Hryhorenko', 'Security Specialist', 'USA', 'New York', false, '', 10, 7),
    (8971, 'Irena', 'Hryhorenko', 'Data Analyst', 'Ukraine', 'Mykolaiv', true, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 8, 6),
    (8972, 'Тарас', 'Кравченко', 'Software Developer', 'Ukraine', 'Kyiv', true, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 14, 12),
    ...
    (8978, 'Наталія', 'Мороз', 'UI/UX Designer', 'Ukraine', 'Kyiv', true, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 9, 7),
    (8979, 'Natalia', 'Moroz', 'Design Engineer', 'USA', 'Miami', false, 'iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAIAAAADnC86AAAALUlEQVR4nO3NAQ0AAAgDILV/Z43xzUEBeitjQq9YLBaLxWKxWCwWLGFiVgkMAVzYG6LAAAAAElFTkSuQmCC', 10, 8),
    (8980, 'Nataliya', 'Moroz', 'Product Designer', 'Ukraine', 'Poltava', true, '', 12, 10)
) AS new_users (id, first_name, last_name, status, country, city, is_subscribed, picture, completed_interviews, conducted_interviews)
WHERE NOT EXISTS (SELECT 1
                  FROM users
                  WHERE id = new_users.id);
