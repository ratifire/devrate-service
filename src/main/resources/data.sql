...
INSERT INTO users (id, first_name, last_name, position, country, city, is_subscribed, description)
SELECT * FROM (
    VALUES
...
) AS new_users (id, first_name, last_name, position, country, city, is_subscribed, description)
WHERE NOT EXISTS (
